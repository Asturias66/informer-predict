...
parser.add_argument('--data', type=str, default='601398', help='data')
parser.add_argument('--root_path', type=str, default='./data/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='601398.csv', help='data file')
...
data_parser = {
    ...
    '601398':{'data':'601398.csv','T':'close','M':[5,5,5],'S':[1,1,1],'MS':[5,5,1]}
}
